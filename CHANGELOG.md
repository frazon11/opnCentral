...
- Allowed read-only searches, status calls, inventories, configuration views and backups while locked.
...
- Republished the consistent management-layout release as version 0.6.4.0.
...
- Released the OpenVPN Roadwarrior server wizard as version 0.6.4.0.
