...
- Docker images are now published as `0.6.8.0`, `latest`, and `sha-<commit>`.
...
- Pinned the supplied compose file to `ghcr.io/frazon11/opncentral:0.6.8.0`.
...
- Republished the consistent management-layout release as version 0.6.8.0.
...
- Released the OpenVPN Roadwarrior server wizard as version 0.6.8.0.
